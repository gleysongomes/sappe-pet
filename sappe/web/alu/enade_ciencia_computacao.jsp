<%-- 
    Document   : enade_ciencia_computacao
    Created on : 26/08/2012, 23:16:59
    Author     : gleyson
--%>
...
<html>
    ...
    <body>
        <div id="content">
            ...
            <div id="content_left">
                <h1 class="titulo">Enade Ciência da Computação</h1><br />
                <form action="../ServletCentral" method="post" >
                    <input type="hidden" name="comando" value="CmdListarQuestoes" />
                    <input type="hidden" name="id" value="5" />
                    <input type="hidden" name="ide" value="2" />
                    <input type="hidden" name="caminho" value="/alu/enade_ciencia_computacao.jsp" />
